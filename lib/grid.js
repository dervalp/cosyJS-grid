...
var gridBuilder = function( options ) {
    ...
    if ( options.extra && !isString( options.extra ) ) {
        throw "invalid extraClass";
    }
...
var buildPlaceHolder = function( placeHolder, content, configuration ) {
    ...
    if ( placeHolder.size ) {
        ...
        return DOM.div( row, name, placeHolderTemplate + content ).trim( );
    }
};
 ...
 */
gridBuilder.prototype.render = function( structure ) {
    var result = "",
        dic = {},
        self = this;
